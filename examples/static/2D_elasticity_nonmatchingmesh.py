...
V0 = VectorFunctionSpace(domain, ("CG", 1))
du0 = TrialFunction(V0)
u0 = TestFunction(V0)
a0 = inner(sigma(du0), eps(u0))*dx
l0 = -rho_g*u0[1]*dx

V1 = VectorFunctionSpace(domain, ("CG", 1))
du1 = TrialFunction(V1)
u1 = TestFunction(V1)
a1 = inner(sigma(du1), eps(u1))*dx
l1 = -rho_g*u1[1]*dx
...
bc = dirichletbc(u_D, locate_dofs_topological(V0, fdim, boundary_facets), V0)
