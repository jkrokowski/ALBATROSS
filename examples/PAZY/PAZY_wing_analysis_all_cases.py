...
tip_deflections = {}
case_num = 1
for conservation in ["conservative","nonconservative"]:
    for deg in [3,5,7]:
        for pressure in [60,136,543,965,1508,1825]:
            ...
            print('Max vertical deflection of centroid for',deg,'deg,',pressure,'pa,'+conservation)
            tip_deflection=PAZYWing.get_local_disp([tip_pt])[0][2]
            tip_deflections[case_num] = {'tip deflection':tip_deflection,'AOA':deg,'dynamic pressure':pressure,'conservation':conservation}
            case_num +=1
for tip_deflection in tip_deflections.values():
    print(tip_deflection['tip deflection'])
print() 
