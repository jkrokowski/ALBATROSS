...
def create_2D_box(pts,thicknesses,num_el,meshname):
     #TODO: need to trim/modify/join the overlapping last line segments?
     '''
     ...
     # #meshtags
     # r1 = gmsh.model.occ.add_rectangle(pt1[0], pt1[1]-t1, 0, pt2[0]-pt1[0], t1)
     # r2 = gmsh.model.occ.add_rectangle(pt3[0]-t2, pt3[1], 0, t2, pt2[1]-pt3[1]-t1)
     # r3 = gmsh.model.occ.add_rectangle(pt4[0], pt4[1], 0, pt3[0]-pt4[0]-t2, t3)
     # r4 = gmsh.model.occ.add_rectangle(pt4[0], pt4[1]+t3, 0, t4, pt1[1]-pt4[1]-2*t1)
     ...
     # box_nodes = [[tlcx,tlcy-t1,tlcx+t4,tlcy],
     #           [tlcx+t4,tlcy,trcx-t2,trcy-t1],
     #           [trcx-t2,trcy-t1,trcx,trcy],
     #           [brcx-t2,brcy+t3,trcx,trcy-t1],
     #           [brcx-t2,brcy,brcx,brcy+t3],
     #           [blcx+t4,blcy,brcx-t2,brcy+t3],
     #           [blcx,blcy,blcx+t4,blcy+t3],
     #           [blcx,blcy+t3,tlcx+t4,tlcy-t1]]
